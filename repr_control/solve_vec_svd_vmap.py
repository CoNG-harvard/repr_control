...
from repr_control.agent.randomized_sac import svd_sac_agent_network
...
if __name__ == "__main__":
    ...
    parser.add_argument("--alg", default="svd_sac",
    ...
    log_path = f'log/{alg_name}/{env_name}/N={N}/kappa={eval_kappa}/start_timesteps={args.start_timesteps}/sigma={sigma}/rsvd_sigma={args.rsvd_sigma}/batchsize={args.batch_size}/V_critic={use_V_critic}/feature_step={args.has_feature_step}/{exp_name}'
