...
# # Running multiple Python scripts
# echo "Running script1.py..."
# python solve_vec_network_vmap.py --seed 159 --batch_size 32 --rf_num 1024 --rf_sigma 0.0 --max_timesteps 3e3

# # Running multiple Python scripts
# echo "Running script1.py..."
# python solve_vec_network_vmap.py --seed 160 --batch_size 32 --rf_num 1024 --rf_sigma 0.0 --max_timesteps 3e3

# # Running multiple Python scripts
# echo "Running script1.py..."
# python solve_vec_network_vmap.py --seed 161 --batch_size 32 --rf_num 1024 --rf_sigma 0.0 --max_timesteps 3e3
