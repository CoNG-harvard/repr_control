...
from repr_control.agent.sac import sac_agent_network_vmap_phi_sa
...
if __name__ == "__main__":
    ...
    ### parameter that
    parser.add_argument("--alg", default="sac_phi_sa",
    ...
    # Initialize policy
    if args.alg == "sac_phi_sa":
        agent = sac_agent_network_vmap_phi_sa.CustomModelSACAgent(dynamics_fn = dynamics, rewards_fn = rewards, **kwargs)
    elif args.alg == 'rfsac':
