...
from repr_control.agent.rfsac import rfsac_agent_network_vmap_decentralized
...
if __name__ == "__main__":
    ...
    log_path = f'log/decentralized/{alg_name}/{env_name}/{exp_name}/N={N}/sigma={sigma}/rf_num={args.rf_num}/learn_rf={args.learn_rf}/batchsize={args.batch_size}/use_layer_norm={args.use_layer_norm}'
    ...
    if args.alg == "sac":
        ...
        agent = rfsac_agent_network_vmap_decentralized.CustomModelRFSACAgent(dynamics_fn = dynamics, 
                                                               rewards_fn = rewards, 
                                                            #    learn_rf = True,
                                                               **kwargs)
    else:
    ...
    if args.env == 'custom':
        ...
        env = CustomVecEnv(
                       ...
                       rewards=rewards,
                       initial_distribution = initial_distribution,
                       rand_distribution = initial_distribution,
                       state_range=state_range,
                       action_range=action_range,
                       sigma=sigma,
