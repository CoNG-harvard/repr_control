...
if __name__ == "__main__":
    ...
    log_path = f'log/replay/{alg_name}/{env_name}/N={N}/kappa={eval_kappa}/sigma={sigma}/rf_sigma={args.rf_sigma}/rf_num={args.rf_num}/learn_rf={args.learn_rf}/batchsize={args.batch_size}/use_layer_norm={args.use_layer_norm}/tau={args.tau}/{exp_name}'
